...
screen say(who, what):
    ...
    ## Painel inclusivo ligado automaticamente à fala atual.
    use painel_libras(what)
...
screen quick_menu():
    ...
    if quick_menu:
        ...
        vbox:
            ...
            # Exibe a frase indicativa apenas ao passar o mouse sobre o botão
            if tooltip:
                text tooltip size 16 color "#ffffff" xalign 0.5 yoffset -5 outlines [(1, "#000000", 0, 0)]
            ...
            hbox:
                ...
                textbutton _("Voltar"):
                    action Rollback()
                    tooltip "Use as setas do teclado (← Voltar / → Avançar)"

                textbutton _("Pausar") action ShowMenu('pause')
...
screen main_menu():
    ...
    # Painel com a lista de atalhos no canto da tela
    frame:
        xalign 0.98
        yalign 0.95
        padding (15, 15)
        ...
        vbox:
            spacing 5
            text "Controles do Teclado" size 18 bold True color "#ffffff"
            null height 5
            text "← : Voltar fala" size 14 color "#ccc"
            text "→ / Espaço / Enter : Avançar fala" size 14 color "#ccc"
            text "P / Esc : Pausar / Menu" size 14 color "#ccc"
            text "Ctrl (Segurar) : Pular texto" size 14 color "#ccc"
            text "↑ / Roda do Mouse : Histórico" size 14 color "#ccc"
            text "H : Ocultar interface" size 14 color "#ccc"
...
screen pause():
    ...
    frame:
        ...
        vbox:
            spacing 15
            xalign 0.5
            text "JOGO PAUSADO" size 32 bold True xalign 0.5
            null height 10
